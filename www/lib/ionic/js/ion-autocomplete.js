        ...
        return {
            ...
            link: function (scope, element, attrs, controllers) {
                ...
                var template = [
                    ...
                    '<ion-item ng-repeat="item in viewModel.searchItems | filter:viewModel.searchQuery | orderBy:\'nome\'" item-height="55px" item-width="100%" ng-click="viewModel.selectItem(item)" class="item-text-wrap">',
